...
| Flag                | Purpose                                                                                                                     | Default |
| ------------------- | --------------------------------------------------------------------------------------------------------------------------- | ------- |
| `--only-images`     | Limit to image attachments (png, jpg, gif, svg, webp, …).                                                                    | `false` |
| `--only-pdf`        | Limit to PDF attachments.                                                                                                    | `false` |
| `--only-other`      | Limit to other attachments (video, audio, archives, office docs).                                                            | `false` |
